...
# Relative imports from the new package structure
from .networks_3d import Network_3D
from .networks_2d import Network_2D, load_yaml
...
class OpenYolo3D():
    ...
    def save_output_as_ply(self, save_path, th = 0.1):
        # This part requires load_mesh_or_pc which was in models.Mask3D.mask3d
        # We'll need to fix this import too.
